...
abstract class MusicDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // Migration from version 10 to 11 (메트로놈 점음표 박: user_preferences.metronomeDottedBeat)
        // nullable 컬럼만 더한다. null = 분모 음표로 센다 (v0.2.1 까지의 동작) (#052).
        private val MIGRATION_10_11 = object : Migration(10, 11) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE user_preferences ADD COLUMN metronomeDottedBeat INTEGER")
            }
        }
